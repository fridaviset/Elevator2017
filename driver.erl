-module(driver).
-export([start/0, set_motor_direction/1]).
-export([start/1]).
...
set_motor_direction(Direction)-> driver_pid ! {set_motor_direction, Direction}.
...
new_order(Direction, Floor) -> 
    order_distributer_pid ! {new_order, Direction, Floor},
